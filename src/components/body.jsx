    ...
    <Grid container>
        ...
        <Grid xs={12} md={4} className="container-4">
            ...
            <div className="container-5">
                <p >HTML • CSS • Flexbox • Grid • Bootstrap • Javascript • DOM Manipulation • jQuery • Bash Command Line • Git, GitHub and Version Control • Backend Web Development • Node.js • NPM • Express.js • EJS • REST • APIs • Databases • SQL • PostgreSQL • Mysql • Authentication • oauth • Password hashing • React.js • Web Design • Deployment with GitHub Pages • MUI React </p>
            </div>
        </Grid>
        <Grid xs={12} md={4} className="container-2">
